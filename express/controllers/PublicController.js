...
const generatePdfReport = async (request, response) => {
  await PdfController.handleRequest(request, response, service.generatePdfReport)
}

const getAllQuestionCategories = async (request, response) => {
  
  await Controller.handleRequest(request, response, service.getAllQuestionCategories)
}

const getAllQuestions = async (request, response) => {
    console.log("getAllQuestions request",request)
...
const getCategoryQuestions = async (request, response) => {
  await Controller.handleRequest(request, response, service.getCategoryQuestions)
}
...
const getQuestionCategory = async (request, response) => {
  await Controller.handleRequest(request, response, service.getQuestionCategory)
}

const postCategoryCoreResult = async (request, response) => {
  await Controller.handleRequest(request, response, service.postCategoryCoreResult)
}

const queryQuestionCategoryResult = async (request, response) => {
  await Controller.handleRequest(request, response, service.queryQuestionCategoryResult)
}
