...
const generatePdfReport = (req) =>
  ...
  new Promise(async (resolve, reject) => {
    console.log('-----------------generatePdfReport----------', req);
    try {
      ...
      if (req.answers.Questions && req.answers.Questions.length > 0) {
        answeredQuestions = req.answers.Questions || {};
      }
      ...
      reject(Service.reject(405, 'Invalid input', e.message));
    }
  });
