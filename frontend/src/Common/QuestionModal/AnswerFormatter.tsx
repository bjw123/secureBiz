...
export const answerFormatter = (questArr: any, answerArr: number []):any => {

  let newArr = questArr;

  questArr.forEach((v:any,i:number)=> {
    let answerTemp = v.Answers;

    if(v.QuestionType === "MULTIPLE")
    {
      let multArr:any = []
      console.log(" answerTemp[answerArr[i]]", answerTemp[answerArr[i]])
      //@ts-ignore=8  
      answerArr[i].forEach<any>((v:string,index:number)=> {
        
        multArr.push(answerTemp[v]) 
        console.log("multArr",multArr)
      })
      newArr[i].Answers = multArr;
      console.log(" newArr[i].Answers = multArr;",newArr[i].Answers)
    }
    else {
     
      let newAnswer = answerTemp[answerArr[i]]
      newArr[i].Answers = [newAnswer]
    }
    ...
    "Questions":[
      {
        ...
        "Validators":"Yup.string().oneOf(['a','b','c'])"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef86fe",
        "QuestionCategory":"AppControl",
      ...
      },
      {
        ...
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":4,"QuestionNextCore":4},
          {"Value":false,"Label":"No","QuestionNext":4,"QuestionNextCore":4}
        ],
        "Validators":"Yup.boolean()"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8700",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":5,"QuestionNextCore":null},
          {"Value":false,"Label":"No","QuestionNext":5,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean()"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8701",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":6,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean()"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8702",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":7,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean()"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8703",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":8,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean()"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8704",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":9,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean().required('Required')"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8705",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":10}
        ],
        "Validators":"Yup.boolean().required('Required')"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8706",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":11,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean().required('Required')"
      },
      {
        "_id":"6003cbfc6f7c0260e4ef8707",
        "QuestionCategory":"AppControl",
        ...
        "QuestionCore":false,
        "Answers":[
          {"Value":true,"Label":"Yes","QuestionNext":12,"QuestionNextCore":null}
        ],
        "Validators":"Yup.boolean().required('Required')"
      }
    ]
